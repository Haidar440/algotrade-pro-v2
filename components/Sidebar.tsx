      ...
      >
        ...
        <nav className="px-3 space-y-1.5 mt-6 flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-slate-700">
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 font-medium ${activeView === 'WATCHLIST' ? 'bg-slate-800 text-white' : 'text-slate-400 hover:bg-slate-800 hover:text-slate-200'
              }`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 font-medium ${activeView === 'BACKTEST' ? 'bg-slate-800 text-white' : 'text-slate-400 hover:bg-slate-800 hover:text-slate-200'
              }`}
          >
          ...
          {/* AI Stock Picks */}
          <button
            onClick={() => { onSelectView('AI_PICKS'); onClose(); }}
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 font-medium ${activeView === 'AI_PICKS' ? 'bg-cyan-600 text-white shadow-lg shadow-cyan-900/30' : 'text-slate-400 hover:bg-slate-800 hover:text-cyan-400'
              }`}
          >
            <Target className="w-5 h-5" /> AI Stock Picks
            <span className="ml-auto text-[9px] bg-cyan-500/20 text-cyan-300 px-1.5 py-0.5 rounded uppercase font-bold">AI</span>
          </button>

          {/* Performance Analytics */}
          <button
            onClick={() => { onSelectView('ANALYTICS'); onClose(); }}
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 font-medium ${activeView === 'ANALYTICS' ? 'bg-purple-600 text-white shadow-lg shadow-purple-900/30' : 'text-slate-400 hover:bg-slate-800 hover:text-purple-400'
              }`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 font-medium ${activeView === 'NEWS' ? 'bg-slate-800 text-white' : 'text-slate-400 hover:bg-slate-800 hover:text-slate-200'
              }`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 font-medium ${activeView === 'STRATEGIES' ? 'bg-slate-800 text-white' : 'text-slate-400 hover:bg-slate-800 hover:text-slate-200'
              }`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 font-medium text-rose-400 hover:bg-rose-500/10 hover:text-rose-300 mt-auto`}
          >
